...
export function PageHero({
  ...
  return (
    <section className="relative flex min-h-[280px] items-end overflow-hidden bg-charcoal-950 pt-16 sm:min-h-[360px] lg:min-h-[420px] lg:pt-20">
      <ImageSlot cover alt={imageAlt} label={imageLabel} objectPosition="center 65%" />
